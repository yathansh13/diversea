        ...
        <input required type="text" placeholder="Name" />
          ...
          <div className="varsity">
            ...
            <select className="gender alldrop" name="gender">
              ...
              <option value="zz">ze/zir</option>
              <option value="xx">xe/xim</option>
              <option value="cc">co/co</option>
              <option value="ee">ey/em</option>
              <option value="vv">ve/ver</option>
              <option value="pp">per/per</option>
            </select>
           </div>
